...
class ProductBacklogItemServiceTest {
    ...
    fun ensureUpdateProductBacklogItemWorksProperly() {
        ...
        val updatedProductBacklogItem =
            productBacklogItemService.updateProductBacklogItem(productOwner, productBacklogItem, title, description)

        // Then
        assertThat(updatedProductBacklogItem.title).isEqualTo(title)
        assertThat(updatedProductBacklogItem.description).isEqualTo(description)
    }

    @Test
    fun ensureUpdateProductBacklogItemThrowsWhenProductOwnerBelongsToAnotherProject() {
        // Given
        val projectId = UUID.randomUUID()
        val anotherProjectId = UUID.randomUUID()
        val productOwner =
        ...
        // When
        assertThrows<IllegalArgumentException> {
            productBacklogItemService.updateProductBacklogItem(productOwner, productBacklogItem, "Update Backlog", "Updated description")
        }
    }

    @Test
    fun ensureUpdateProductBacklogItemThrowsWhenCallerIsScrumMaster() {
        // Given
        val projectId = UUID.randomUUID()
        val productBacklogItem =
            ProductBacklogItem(
        ...
        // When
        assertThrows<IllegalArgumentException> {
            productBacklogItemService.updateProductBacklogItem(null, productBacklogItem, "Update Backlog", "Updated description")
        }
    }

    @Test
    fun ensureUpdateProductBacklogItemThrowsWhenCallerIsDeveloper() {
        // Given
        val projectId = UUID.randomUUID()
        val productBacklogItem =
            ProductBacklogItem(
    ...
    @Test
    fun ensureUpdateProductBacklogItemThrowsWhenTitleIsBlank() {
        // Given
        val projectId = UUID.randomUUID()
        val productOwner =
            ProductOwner(
        ...
        // When
        assertThrows<IllegalArgumentException> {
            productBacklogItemService.updateProductBacklogItem(productOwner, productBacklogItem, "", "Updated description")
        }
    }

    @Test
    fun ensureUpdateProductBacklogItemThrowsWhenDescriptionIsBlank() {
        // Given
        val projectId = UUID.randomUUID()
        val productOwner =
            ProductOwner(
        ...
        // When
        assertThrows<IllegalArgumentException> {
            productBacklogItemService.updateProductBacklogItem(productOwner, productBacklogItem, "Update Backlog", "")
        }
    }
}
